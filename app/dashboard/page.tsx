      ...
      <div className="hidden md:block space-y-6 animate-in">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-row gap-3">
            <Link href="/members/add" className="flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 text-sm font-bold">
              <UserPlus className="w-4 h-4" /> Add Member
            </Link>
            <Link href="/payments" className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-gray-200 text-gray-700 rounded-2xl hover:bg-gray-50 transition-all shadow-sm text-sm font-bold">
